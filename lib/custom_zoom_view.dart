...
class _CustomZoomViewState extends State<CustomZoomView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: 'android_custom_zoom_sdk',
    ...
    return Text(
        '$defaultTargetPlatform is not yet supported by the android_custom_zoom_sdk plugin');
  }
...
class ZoomViewController {
  ZoomViewController._(int id)
      : _methodChannel = new MethodChannel('android_custom_zoom_sdk'),
